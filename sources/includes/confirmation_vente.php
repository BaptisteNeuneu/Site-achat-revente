        ...
        <div class="w3-card-4 w3-center ">
            <?php if(isset($_GET["m"])) : ?>
                ...
                <?php elseif(strcmp($_GET["m"], "err_count") == 0) : ?>
                    <div class="w3-panel w3-red w3-padding-none">
                        <h3 >Erreur</h3>
                        <p>Vous ne pouvez plus vendre autant de produit</p>
                    </div>
                <?php elseif(strcmp($_GET["m"], "max_stash") == 0) : ?>
                    <div class="w3-panel w3-red w3-padding-none">
                        <h3 >Erreur</h3>
                        <p>Vous ne pouvez pas vendre ce produit. <br/>
                            Votre cagnotte dépasserait 65 000€.</p>
                    </div>
                <?php endif ?>
            <?php endif ?>
