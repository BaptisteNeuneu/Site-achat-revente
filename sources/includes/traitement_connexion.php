<?php
    ...
    if(isset($_POST["login"]) && isset($_POST["password"])) {
        ...
        //Requête préparée
        $stmt = mysqli_prepare($db, "SELECT id, login, password FROM Customer NATURAL JOIN CustomerProtectedData WHERE login = ? OR email = ?");
        ...
        } else $error = "Ce login ou cette adresse mail n'existe pas";
    }
    mysqli_close($db);
?>